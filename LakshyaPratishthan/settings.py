"""
Django settings for LakshyaPratishthan project.
...
MIDDLEWARE = [
    'api.custom_middleware.CorsMiddleware',
...
ROOT_URLCONF = 'LakshyaPratishthan.urls'
...
WSGI_APPLICATION = 'LakshyaPratishthan.wsgi.application'
