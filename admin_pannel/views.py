...
#         api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/agentlogin/"
...
def diwali_kirana_list(request):
    ...
    """
    api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/list_all_registrations/"
    error_message = None
...
def proxy_bulk_update_view(request):
    ...
    try:
        ...
        backend_api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/bulk_update_diwali_kirana/"
...
def proxy_add_member_view(request):
    ...
    try:
        data_from_frontend = json.loads(request.body)
        backend_api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/add_diwali_family_member/"
...
def proxy_upload_voter_id_view(request):
    ...
    """
    try:
        backend_api_url = "https://lakshyapratishthan.com/LakshyaPratishthan/api/upload_voter_id/"
...
def proxy_delete_member_view(request, reg_id):
    ...
    try:
        ...
        backend_api_url = f"https://lakshyapratishthan.com/LakshyaPratishthan/api/delete_diwali_member/{reg_id}/"
